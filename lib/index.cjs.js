...
var convertListToTree = function (list, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.id, id = _c === void 0 ? "id" : _c, _d = _b.parentId, parentId = _d === void 0 ? "pid" : _d, _e = _b.children, children = _e === void 0 ? "children" : _e, _f = _b.isParentValue, isParentValue = _f === void 0 ? "0" : _f;
    var tree = [];
    var map = new Map();
    // 首先遍历列表，创建一个 id 到对象的映射
    list.forEach(function (item) {
        var _a;
        map.set(item[id], __assign(__assign({}, item), (_a = {}, _a[children] = [], _a)));
    });
